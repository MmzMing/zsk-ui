...
export const mockAdminMenuTree: AdminMenuNode[] = [
  {
    id: "001",
    name: "仪表盘",
    path: routes.admin,
  ...
  },
  {
    ...
    parentId: null,
    children: [
      { id: "005001", name: "审核队列", path: `${routes.admin}/video/review`, iconName: "FiCheckSquare", order: 1, visible: true, permissionKey: "video:review", parentId: "005" },
      ...
      { id: "005003", name: "分类管理", path: `${routes.admin}/video/category`, iconName: "FiGrid", order: 3, visible: true, permissionKey: "video:category", parentId: "005" }
    ]
  },
  {
    id: "006",
    ...
    parentId: null,
    children: [
      { id: "006001", name: "文档列表", path: `${routes.admin}/document/list`, iconName: "FiList", order: 1, visible: true, permissionKey: "document:list", parentId: "006" },
      { id: "006002", name: "回收站", path: `${routes.admin}/document/trash`, iconName: "FiTrash2", order: 2, visible: true, permissionKey: "document:trash", parentId: "006" }
    ]
  }
];