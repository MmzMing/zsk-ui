...
export const adminMenuTree: AdminMenuNode[] = [
  ...
  },
  {
    ...
    parentId: null,
    children: [
      { id: "002001", name: "系统监控", path: `${routes.admin}/ops/systemMonitor`, iconName: "FiList", order: 1, visible: true, permissionKey: "ops:systemMonitor", parentId: "002" },
      { id: "002002", name: "缓存监控", path: `${routes.admin}/ops/cacheMonitor`, iconName: "FiList", order: 2, visible: true, permissionKey: "ops:cacheMonitor", parentId: "002" },
      { id: "002003", name: "缓存列表", path: `${routes.admin}/ops/cacheList`, iconName: "FiList", order: 3, visible: true, permissionKey: "ops:cacheList", parentId: "002" },
      { id: "002004", name: "系统日志", path: `${routes.admin}/ops/systemLog`, iconName: "FiList", order: 4, visible: true, permissionKey: "ops:systemLog", parentId: "002" },
      { id: "002005", name: "用户行为", path: `${routes.admin}/ops/userBehavior`, iconName: "FiList", order: 5, visible: true, permissionKey: "ops:userBehavior", parentId: "002" }
    ]
  },
  {
    id: "003",
