  ...
  return (
    <div className="min-h-screen flex bg-[var(--bg-color)] text-[var(--text-color)]">
      <div className="hidden lg:flex lg:basis-2/3 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-80 bg-[radial-gradient(circle_at_0%_0%,rgba(94,234,212,0.35),transparent_55%),radial-gradient(circle_at_100%_100%,rgba(59,130,246,0.35),transparent_55%)]" />
        <div className="relative z-10 flex flex-col justify-between p-10 xl:p-14 w-full">
          ...
          <div className="space-y-5 text-slate-100">
            ...
            <p className="text-xs text-slate-200/80 leading-relaxed max-w-md">
              输入绑定邮箱后，我们将发送验证码帮助你重置登录密码。验证码仅在短时间内有效，请注意查收邮件。
            </p>
          </div>
